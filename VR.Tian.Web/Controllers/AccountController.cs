...
using VR.Tian.Sessions;
using VR.Tian.Web.Controllers.Results;
using VR.Tian.Web.Models;
using VR.Tian.Web.Models.Account;
using Microsoft.AspNet.Identity;
using Microsoft.AspNet.Identity.Owin;
using Microsoft.Owin.Security;

namespace VR.Tian.Web.Controllers
{
    public class AccountController : TianControllerBase
    {
